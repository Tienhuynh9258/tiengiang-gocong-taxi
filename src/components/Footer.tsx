        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="mb-4 flex items-center">
              <span className="text-2xl font-bold text-white">TIỀN GIANG</span>
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-brand-blue text-white p-2 rounded-full hover:bg-brand-lightBlue transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex">
                <MapPin className="h-5 w-5 text-brand-yellow mr-3 flex-shrink-0" />
                <span className="text-gray-300">
                  123 Đại lộ Lê Lợi, TP. Mỹ Tho, Tiền Giang
                </span>
              </li>
              <li className="flex">
                <PhoneCall className="h-5 w-5 text-brand-yellow mr-3 flex-shrink-0" />
                <div>
                  <p className="text-gray-300">0909 123 456</p>
                  <p className="text-gray-300">0909 456 789</p>
                </div>
              </li>
              <li className="flex">
                <Mail className="h-5 w-5 text-brand-yellow mr-3 flex-shrink-0" />
                <div>
                  <p className="text-gray-300">info@taxitiengiang.com</p>
                  <p className="text-gray-300">support@taxitiengiang.com</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Taxi Tiền Giang. Tất cả các quyền được bảo lưu.
            </p>
