      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="mb-4">
              <img 
                src="https://taxiquangnam.io.vn/wp-content/uploads/2023/08/logo-footer.png" 
                alt="Taxi Tiền Giang"
                className="h-16" 
              />
            </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-brand-yellow text-brand-darkBlue p-2 rounded-full hover:bg-yellow-500 transition-colors">
