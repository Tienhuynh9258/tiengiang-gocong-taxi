    ...
    <section id="contact" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Liên Hệ Với Chúng Tôi</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1">
            <div className="bg-brand-gray p-6 rounded-lg shadow-md h-full">
              <h3 className="text-xl font-semibold mb-6 text-gray-800">Thông Tin Liên Hệ</h3>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="mt-1 bg-brand-blue rounded-full p-2 text-white">
              ...
              <div className="mt-8">
                <h4 className="text-lg font-semibold mb-4 text-gray-800">Theo dõi chúng tôi</h4>
